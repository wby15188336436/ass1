...
if __name__ == "__main__":
    ...
    if args["q1b"]:
        for index, row in (t := tqdm(question_1b.iterrows(), total=question_1b.shape[0])):
            ...
            re_match = re.search(r"Number\sof\snode\sexpansions:\s*(.*)$", result.stdout.decode('utf-8'), re.MULTILINE)
            question_1b.at[index, 'node_expansions'] = re_match.group(1) if re_match else None
